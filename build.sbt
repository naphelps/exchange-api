...
lazy val root = (project in file("."))
  .settings(
    ...
    Docker / version        := sys.env.getOrElse("IMAGE_VERSION", versionFunc()) ++ "-testing-1", // overwrite this setting to build a test version of the exchange with a custom tag in docker, defaults to exchange version
